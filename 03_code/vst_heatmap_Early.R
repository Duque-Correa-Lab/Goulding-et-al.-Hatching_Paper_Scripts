...
deseq2VST <- deseq2VST %>%
  mutate(
    timepoint = case_when(
      variable ==24~ 'L1_Unhatched_2 ',
      variable ==23~ 'L1_Unhatched_3 ',
      variable ==22~ 'L1_Unhatched_4 ',
      variable ==21~ 'L1_Unhatched_5 ',
      variable ==20~ 'L1_Unhatched_6 ',
      variable ==19~ 'L1_Hatched_1 ',
      variable ==18~ 'L1_Hatched_2 ',
      variable ==17~ 'L1_Hatched_3 ',
      variable ==16~ 'L1_3hr_2 ',
      variable ==15~ 'L1_3hr_3 ',
      variable ==14~ 'L1_3hr_4 ',
      variable ==13~ 'L1_3hr_6 ',
      variable ==12~ 'L1_24hr_1 ',
      variable ==11~ 'L1_24hr_2 ',
      variable ==10~ 'L1_24hr_3 ',
      variable ==9~ 'L1_24hr_4 ',
      variable ==8~ 'L1_24hr_5 ',
      variable ==7~ 'L1_24hr_6 ',
      variable ==6~ 'L2_1 ',
      variable ==5~ 'L2_2 ',
      variable ==4~ 'L2_3 ',
      variable ==3~ 'L2_4 ',
...
samples <- ggplot(sampleinfo, aes(x=timepoint, y=1, fill=timepoint)) + geom_tile() + scale_x_discrete(expand=c(0, 0)) + scale_y_discrete(expand=c(0, 0)) + theme_void()
